...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('branch.dashboard') }}" class="text-blue-500 hover:underline">
            Back to Dashboard
        </a>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-lg p-6">
        <div class="space-y-6">
            ...
            <div>
                ...
                <form action="{{ route('branch.profile.update') }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" value="{{ $user->branch->name ?? 'No branch assigned' }}" 
                                   class="mt-1 block w-full rounded-md border-gray-300 bg-gray-50 shadow-sm" readonly>
                        </div>
                    </div>
            ...
            <div class="border-t pt-6">
                ...
                <form action="{{ route('branch.password.update') }}" method="POST">
                    @csrf
                    @method('PUT')
