...
<div class="container mx-auto px-4 sm:px-6 lg:px-8">
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-semibold text-gray-900">Add New Banner - {{ \App\Models\Banner::getSections()[$section] }}</h3>
        </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="3" 
                                  class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-brand-yellow focus:ring focus:ring-brand-yellow focus:ring-opacity-50 @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        <label for="image" class="block text-sm font-medium text-gray-700">Banner Image <span class="text-red-500">*</span></label>
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            @if($section === \App\Models\Banner::SECTION_WEB_HOME)
                                Recommended size: 1920x600 pixels
                            @elseif($section === \App\Models\Banner::SECTION_MOBILE_APP_MAIN)
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <a href="{{ route('admin.banners.index', ['section' => $section]) }}" 
