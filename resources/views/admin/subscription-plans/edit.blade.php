...
<div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
    <div class="px-4 py-6 sm:px-0">
        <div class="mb-6">
            <h2 class="text-2xl font-bold text-gray-900">Edit Subscription Plan</h2>
        </div>
                ...
                <div class="grid grid-cols-1 gap-6">
                    <div>
                        ...
                        <select name="type" id="type" required class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            ...
                            <option value="{{ App\Models\SubscriptionPlan::TYPE_KATHA }}" {{ $plan->type === App\Models\SubscriptionPlan::TYPE_KATHA ? 'selected' : '' }}>Katha Plan</option>
                            <option value="{{ App\Models\SubscriptionPlan::TYPE_O2 }}" {{ $plan->type === App\Models\SubscriptionPlan::TYPE_O2 ? 'selected' : '' }}>O2 Plan</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="3" required
                            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">{{ old('description', $plan->description) }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="validity_days" id="validity_days" value="{{ old('validity_days', $plan->validity_days) }}" required min="1"
                            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    </div>
