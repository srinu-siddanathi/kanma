                    ...
                    <div class="bg-gray-50 rounded-lg p-6">
                        ...
                        <div id="variants-container" class="space-y-4">
                            @forelse($product->variants as $index => $variant)
                                <!-- Existing variants -->
                                @include('admin.products.partials.variant-row', [
                                    'variant' => $variant,
                                    'index' => $index
                                ])
                            @empty
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div>
                            ...
                            <div class="mt-1 relative rounded-md shadow-sm">
                                ...
                                <input type="number" 
                                       ...
                                       class="pl-7 focus:ring-indigo-500 focus:border-indigo-500 block w-full rounded-md sm:text-sm border-gray-300" 
                                       step="0.01" 
                                       required>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   ...
                                   class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full rounded-md sm:text-sm border-gray-300" 
                                   required>
                        </div>
                    </div>
                </div>
