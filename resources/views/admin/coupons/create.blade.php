...
<div class="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
    <div class="px-4 py-6 sm:px-0">
        ...
        <div class="bg-white shadow sm:rounded-lg">
            <form action="{{ route('admin.coupons.store') }}" method="POST" class="space-y-6 p-6">
                @csrf
                        ...
                        <div>
                            ...
                            <div class="flex">
                                <input type="text" name="code" id="code" value="{{ old('code') }}" 
                                       ...
                                       placeholder="Enter coupon code or leave empty to auto-generate" maxlength="50">
                ...
                <div class="border-b border-gray-200 pb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                    <span class="text-gray-500 sm:text-sm" id="value-suffix">%</span>
                                </div>
                            </div>
                            @error('value')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="number" name="minimum_order_amount" id="minimum_order_amount" value="{{ old('minimum_order_amount', 0) }}" required min="0" step="0.01"
                                       class="block w-full px-4 py-3 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 placeholder-gray-400 text-gray-900"
                    ...
                    <div class="mt-6">
                        ...
                        <div class="relative">
                            <input type="number" name="maximum_discount" id="maximum_discount" value="{{ old('maximum_discount') }}" min="0" step="0.01"
                                   class="block w-full px-4 py-3 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 placeholder-gray-400 text-gray-900"
                ...
                <div class="border-b border-gray-200 pb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="per_user_limit" id="per_user_limit" value="{{ old('per_user_limit', 1) }}" required min="1"
                                   class="block w-full px-4 py-3 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 placeholder-gray-400 text-gray-900"
                    ...
                    <div class="mt-6">
                        <label class="inline-flex items-center">
                            <input type="checkbox" name="is_first_time_only" value="1" {{ old('is_first_time_only') ? 'checked' : '' }}
