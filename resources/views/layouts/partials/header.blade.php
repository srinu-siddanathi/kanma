...
// Add SVG definitions for password toggle icons
document.addEventListener('DOMContentLoaded', function() {
    if (!document.getElementById('password-toggle-icons')) {
        const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
        svg.setAttribute('style', 'display: none;');
        svg.setAttribute('id', 'password-toggle-icons');
        
        const defs = document.createElementNS('http://www.w3.org/2000/svg', 'defs');
        
        // Eye icon
        const eyeSymbol = document.createElementNS('http://www.w3.org/2000/svg', 'symbol');
        eyeSymbol.setAttribute('id', 'eye');
        eyeSymbol.setAttribute('viewBox', '0 0 24 24');
        eyeSymbol.setAttribute('fill', 'currentColor');
        eyeSymbol.innerHTML = '<path d="M12 4.5C7 4.5 2.73 7.61 1 12c1.73 4.39 6 7.5 11 7.5s9.27-3.11 11-7.5c-1.73-4.39-6-7.5-11-7.5zM12 17c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zm0-8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z"/>';
        
        // Eye-slash icon
        const eyeSlashSymbol = document.createElementNS('http://www.w3.org/2000/svg', 'symbol');
        eyeSlashSymbol.setAttribute('id', 'eye-slash');
        eyeSlashSymbol.setAttribute('viewBox', '0 0 24 24');
        eyeSlashSymbol.setAttribute('fill', 'currentColor');
        ...
        defs.appendChild(eyeSymbol);
        defs.appendChild(eyeSlashSymbol);
